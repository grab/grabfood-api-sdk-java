...
public class OrderDeliveryRequest {
  ...
  public OrderDeliveryRequest orderID(String orderID) {
  ...
  public OrderDeliveryRequest fromState(FromStateEnum fromState) {
  ...
  public OrderDeliveryRequest toState(ToStateEnum toState) {
   ...
   * @return the OrderDeliveryRequest instance itself
   */
  public OrderDeliveryRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orderID, orderDeliveryRequest.orderID) &&
        Objects.equals(this.fromState, orderDeliveryRequest.fromState) &&
        Objects.equals(this.toState, orderDeliveryRequest.toState)&&
        Objects.equals(this.additionalProperties, orderDeliveryRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orderID, fromState, toState, additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to OrderDeliveryRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!OrderDeliveryRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in OrderDeliveryRequest is not found in the empty JSON string", OrderDeliveryRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : OrderDeliveryRequest.openapiRequiredFields) {
      ...
      // validate the required field `fromState`
      FromStateEnum.validateJsonElement(jsonObj.get("fromState"));
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!OrderDeliveryRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'OrderDeliveryRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<OrderDeliveryRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(OrderDeliveryRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<OrderDeliveryRequest>() {
           @Override
           public void write(JsonWriter out, OrderDeliveryRequest value) throws IOException {
           ...
           @Override
           public OrderDeliveryRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             OrderDeliveryRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of OrderDeliveryRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of OrderDeliveryRequest
   * @throws IOException if the JSON string is invalid with respect to OrderDeliveryRequest
   */
  public static OrderDeliveryRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, OrderDeliveryRequest.class);
  }

  /**
   * Convert an instance of OrderDeliveryRequest to an JSON string
   *
   * @return JSON string
   */
