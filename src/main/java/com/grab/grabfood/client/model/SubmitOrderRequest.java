...
public class SubmitOrderRequest {
  ...
  public SubmitOrderRequest orderID(String orderID) {
  ...
  public SubmitOrderRequest shortOrderNumber(String shortOrderNumber) {
  ...
  public SubmitOrderRequest merchantID(String merchantID) {
  ...
  public SubmitOrderRequest partnerMerchantID(String partnerMerchantID) {
  ...
  public SubmitOrderRequest paymentType(PaymentTypeEnum paymentType) {
  ...
  public SubmitOrderRequest cutlery(Boolean cutlery) {
  ...
  public SubmitOrderRequest orderTime(String orderTime) {
  ...
  public SubmitOrderRequest submitTime(OffsetDateTime submitTime) {
  ...
  public SubmitOrderRequest completeTime(OffsetDateTime completeTime) {
  ...
  public SubmitOrderRequest scheduledTime(String scheduledTime) {
  ...
  public SubmitOrderRequest orderState(String orderState) {
  ...
  public SubmitOrderRequest currency(Currency currency) {
  ...
  public SubmitOrderRequest featureFlags(OrderFeatureFlags featureFlags) {
  ...
  public SubmitOrderRequest items(List<OrderItem> items) {
    this.items = items;
    return this;
  }

  public SubmitOrderRequest addItemsItem(OrderItem itemsItem) {
    if (this.items == null) {
  ...
  public SubmitOrderRequest campaigns(List<OrderCampaign> campaigns) {
    this.campaigns = campaigns;
    return this;
  }

  public SubmitOrderRequest addCampaignsItem(OrderCampaign campaignsItem) {
  ...
  public SubmitOrderRequest promos(List<OrderPromo> promos) {
    this.promos = promos;
    return this;
  }

  public SubmitOrderRequest addPromosItem(OrderPromo promosItem) {
    if (this.promos == null) {
  ...
  public SubmitOrderRequest price(OrderPrice price) {
    this.price = price;
    return this;
  }
  ...
  public SubmitOrderRequest dineIn(DineIn dineIn) {
    this.dineIn = dineIn;
    return this;
  }
  ...
  public SubmitOrderRequest receiver(Receiver receiver) {
  ...
  public SubmitOrderRequest orderReadyEstimation(OrderReadyEstimation orderReadyEstimation) {
  ...
  public SubmitOrderRequest membershipID(String membershipID) {
  ...
  public SubmitOrderRequest discounts(List<GrabDiscount1> discounts) {
    this.discounts = discounts;
    return this;
  }

  public SubmitOrderRequest addDiscountsItem(GrabDiscount1 discountsItem) {
  ...
  public SubmitOrderRequest payments(List<Payment> payments) {
    this.payments = payments;
    return this;
  }

  public SubmitOrderRequest addPaymentsItem(Payment paymentsItem) {
   ...
   * @return the SubmitOrderRequest instance itself
   */
  public SubmitOrderRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.orderID, submitOrderRequest.orderID) &&
        Objects.equals(this.shortOrderNumber, submitOrderRequest.shortOrderNumber) &&
        Objects.equals(this.merchantID, submitOrderRequest.merchantID) &&
        Objects.equals(this.partnerMerchantID, submitOrderRequest.partnerMerchantID) &&
        Objects.equals(this.paymentType, submitOrderRequest.paymentType) &&
        Objects.equals(this.cutlery, submitOrderRequest.cutlery) &&
        Objects.equals(this.orderTime, submitOrderRequest.orderTime) &&
        Objects.equals(this.submitTime, submitOrderRequest.submitTime) &&
        Objects.equals(this.completeTime, submitOrderRequest.completeTime) &&
        Objects.equals(this.scheduledTime, submitOrderRequest.scheduledTime) &&
        Objects.equals(this.orderState, submitOrderRequest.orderState) &&
        Objects.equals(this.currency, submitOrderRequest.currency) &&
        Objects.equals(this.featureFlags, submitOrderRequest.featureFlags) &&
        Objects.equals(this.items, submitOrderRequest.items) &&
        Objects.equals(this.campaigns, submitOrderRequest.campaigns) &&
        Objects.equals(this.promos, submitOrderRequest.promos) &&
        Objects.equals(this.price, submitOrderRequest.price) &&
        Objects.equals(this.dineIn, submitOrderRequest.dineIn) &&
        Objects.equals(this.receiver, submitOrderRequest.receiver) &&
        Objects.equals(this.orderReadyEstimation, submitOrderRequest.orderReadyEstimation) &&
        Objects.equals(this.membershipID, submitOrderRequest.membershipID) &&
        Objects.equals(this.discounts, submitOrderRequest.discounts) &&
        Objects.equals(this.payments, submitOrderRequest.payments)&&
        Objects.equals(this.additionalProperties, submitOrderRequest.additionalProperties);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to SubmitOrderRequest
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!SubmitOrderRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubmitOrderRequest is not found in the empty JSON string", SubmitOrderRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SubmitOrderRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SubmitOrderRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SubmitOrderRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SubmitOrderRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SubmitOrderRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<SubmitOrderRequest>() {
           @Override
           public void write(JsonWriter out, SubmitOrderRequest value) throws IOException {
           ...
           @Override
           public SubmitOrderRequest read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             SubmitOrderRequest instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of SubmitOrderRequest given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of SubmitOrderRequest
   * @throws IOException if the JSON string is invalid with respect to SubmitOrderRequest
   */
  public static SubmitOrderRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SubmitOrderRequest.class);
  }

  /**
   * Convert an instance of SubmitOrderRequest to an JSON string
   *
   * @return JSON string
   */
