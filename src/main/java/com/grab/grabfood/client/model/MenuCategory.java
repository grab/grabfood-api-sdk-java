...
import com.grab.grabfood.client.model.MenuItem;
...
public class MenuCategory {
  ...
  public MenuCategory id(String id) {
    this.id = id;
    return this;
  }
  ...
  public MenuCategory nameTranslation(Map<String, String> nameTranslation) {
    this.nameTranslation = nameTranslation;
    return this;
  }

  public MenuCategory putNameTranslationItem(String key, String nameTranslationItem) {
  ...
  public MenuCategory availableStatus(AvailableStatusEnum availableStatus) {
  ...
  public MenuCategory sellingTimeID(String sellingTimeID) {
  ...
  public MenuCategory addItemsItem(MenuItem itemsItem) {
    if (this.items == null) {
   ...
   * @return the MenuCategory instance itself
   */
  public MenuCategory putAdditionalProperty(String key, Object value) {
  ...
  static {
    ...
    openapiRequiredFields.add("sellingTimeID");
   ...
   * @throws IOException if the JSON Element is invalid with respect to MenuCategory
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!MenuCategory.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MenuCategory is not found in the empty JSON string", MenuCategory.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : MenuCategory.openapiRequiredFields) {
      ...
      if (!jsonObj.get("sellingTimeID").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MenuCategory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MenuCategory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MenuCategory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MenuCategory.class));

       return (TypeAdapter<T>) new TypeAdapter<MenuCategory>() {
           @Override
           public void write(JsonWriter out, MenuCategory value) throws IOException {
           ...
           @Override
           public MenuCategory read(JsonReader in) throws IOException {
             JsonElement jsonElement = elementAdapter.read(in);
             validateJsonElement(jsonElement);
             JsonObject jsonObj = jsonElement.getAsJsonObject();
             // store additional fields in the deserialized instance
             MenuCategory instance = thisAdapter.fromJsonTree(jsonObj);
  ...
  /**
   * Create an instance of MenuCategory given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of MenuCategory
   * @throws IOException if the JSON string is invalid with respect to MenuCategory
   */
  public static MenuCategory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MenuCategory.class);
  }

  /**
   * Convert an instance of MenuCategory to an JSON string
   *
   * @return JSON string
   */
