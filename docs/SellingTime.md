...
|------------ | ------------- | ------------- | -------------|
|**startTime** | **String** | The selling time group start time in date &amp; time format. UTC format is expected.  |  [optional] |
|**endTime** | **String** | The selling time group end time in date &amp; time format. UTC format is expected.  |  [optional] |
